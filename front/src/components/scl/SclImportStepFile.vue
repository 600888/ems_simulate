            ...
            <div class="file-card-meta">
              ...
              {{
                $t("addDevice.mmsPoints", {
                  total:
                    (file.point_summary?.yc || 0) +
                    (file.point_summary?.yx || 0) +
                    (file.point_summary?.yk || 0) +
                    (file.point_summary?.yt || 0),
                  yc: file.point_summary?.yc || 0,
                  yx: file.point_summary?.yx || 0,
                  yk: file.point_summary?.yk || 0,
                  yt: file.point_summary?.yt || 0,
                })
              }}
            </div>
          </div>
