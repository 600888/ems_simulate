...
const modbusClient: FieldDefinition[] = [
  ...
  {
    key: "cache_ttl_ms",
    label: "protocolParams.dnp3CacheTtl",
    unit: "protocolParams.ms",
    min: 0,
    max: 86400000,
    default: 0,
  ...
  {
    key: "link_confirm_timeout_ms",
    label: "protocolParams.dnp3LinkConfirmTimeout",
    unit: "protocolParams.ms",
    min: 100,
    max: 120000,
    default: 1000,
  ...
  {
    key: "link_confirm_max_retries",
    label: "protocolParams.dnp3LinkConfirmRetries",
    unit: "protocolParams.timesUnit",
    min: 0,
    max: 100,
    default: 2,
...
const dnp3Server: FieldDefinition[] = [
  ...
  {
    key: "confirm_timeout_ms",
    label: "protocolParams.dnp3ConfirmTimeout",
    unit: "protocolParams.ms",
    min: 100,
    max: 120000,
    default: 5000,
  ...
  {
    key: "confirm_max_retries",
    label: "protocolParams.dnp3ConfirmRetries",
    unit: "protocolParams.timesUnit",
    kind: "number",
    min: 0,
    max: 100,
