<template>
  <el-header class="app-header">
    ...
    <div class="link-container">
      ...
      <!-- Gitee Link -->
      <a href="https://gitee.com/chen-dongyu123" target="_blank" class="icon-link" :title="t('header.gitee')">
      ...
      <!-- GitHub Link -->
      <a href="https://github.com/600888" target="_blank" class="icon-link" :title="t('header.github')">
      ...
      <a href="https://600888.github.io/ems_simulate/" target="_blank" class="icon-link" :title="t('header.onlineDoc')">
