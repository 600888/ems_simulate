...
class DataImporter:
    ...
    def import_data(self, grp_code: str, protocol_type: ProtocolType) -> None:
        self.import_yc_point_data(grp_code, protocol_type)
        self.import_yx_point_data(grp_code, protocol_type)

    def import_yc_point_data(self, grp_code: str, protocol_type: ProtocolType) -> None:
        print(f"import_yc_point_data: {protocol_type.value}")
