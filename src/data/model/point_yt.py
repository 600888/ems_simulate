...
class PointYt(Base):
    ...
    related_yc_id: Mapped[int | None] = mapped_column(
    ...
    iec_type_id: Mapped[str | None] = mapped_column(String(16), nullable=True, comment="IEC104类型标识(如C_SE_NC_1)")
