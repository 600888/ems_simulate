...
class TestPointCalculator(unittest.TestCase):
    ...
    def test_simple_addition(self):
        ...
        # We need to manually call on_source_changed because signals might not work  # noqa: E501
        # in simple unittest without event loop/blinker setup if not careful.       # noqa: E501
