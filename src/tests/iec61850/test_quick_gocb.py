...
da1 = iec61850.DataAttribute_create(
    "stVal", iec61850.toModelNode(do1), iec61850.IEC61850_BOOLEAN, iec61850.IEC61850_FC_ST, 0, 0, 0
)

ds = iec61850.DataSet_create("dsGOOSE1", lln0)
ds_entry = iec61850.DataSetEntry_create(ds, "LD0/GGIO1$ST$Ind1$stVal", 0, None)

gcb = iec61850.GSEControlBlock_create("gcb1", lln0, "0001", "dsGOOSE1", 1, False, 10, 1000)
