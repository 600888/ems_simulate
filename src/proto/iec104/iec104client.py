...
from src.proto.iec104.tls import IEC104OneWayTlsConfig, TlsClientBridge
...
class IEC104Client:
    def __init__(
        ...
        self.port = port
        self._tls_bridge = (
            TlsClientBridge(ip, port, one_way_tls_config.create_client_context()) if one_way_tls_config else None
        )
