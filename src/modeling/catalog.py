...
CHILD_RULES: dict[str, tuple[str, ...]] = {
    ...
    "LN0": (
        ...
        "REPORT_CONTROL",
        "GSE_CONTROL",
        "SAMPLED_VALUE_CONTROL",
        "SETTING_CONTROL",
        "INPUTS",
        "EXTENSION",
    ),
    "LN": ("DOI", "DATASET", "REPORT_CONTROL", "INPUTS", "EXTENSION"),
    "DOI": ("DAI", "SDI", "EXTENSION"),
    "SDI": ("DAI", "SDI", "EXTENSION"),
    "DAI": ("VAL", "EXTENSION"),
    "DATASET": ("FCDA",),
    "REPORT_CONTROL": ("TRG_OPS", "OPT_FIELDS", "RPT_ENABLED", "EXTENSION"),
    "SAMPLED_VALUE_CONTROL": ("SMV_OPTS", "EXTENSION"),
...
PROPERTY_FIELDS: dict[str, list[dict[str, Any]]] = {
    ...
    "SAMPLED_VALUE_CONTROL": [
        {"key": "smvID", "label": "采样值标识", "component": "input", "required": True},
        {"key": "datSet", "label": "数据集引用", "component": "input", "required": True},
        {"key": "confRev", "label": "配置版本", "component": "number", "required": True},
        {"key": "smpRate", "label": "采样率", "component": "number", "required": True},
        {"key": "nofASDU", "label": "每帧 ASDU 数量", "component": "number"},
        {"key": "multicast", "label": "组播", "component": "switch"},
        {
            "key": "securityEnable",
            "label": "安全模式",
            "component": "select",
            "options": ["None", "Signature", "SignatureAndEncryption"],
        },
    ],
    "SMV_OPTS": [
        {"key": "refreshTime", "label": "刷新时间", "component": "switch"},
        {"key": "sampleSynchronized", "label": "采样同步", "component": "switch"},
        {"key": "sampleRate", "label": "携带采样率", "component": "switch"},
        {"key": "dataSet", "label": "携带数据集引用", "component": "switch"},
        {"key": "security", "label": "携带安全字段", "component": "switch"},
        {"key": "timestamp", "label": "携带时间戳", "component": "switch"},
        {"key": "synchSourceId", "label": "携带同步源标识", "component": "switch"},
    ],
    "SETTING_CONTROL": [
